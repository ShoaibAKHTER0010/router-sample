  ...
  return (
    <div className="bg-blue-500 text-white py-20 ">
      <div className="mx-auto flex items-center justify-center flex-col">
        ...
        <button className="bg-white text-blue-500 py-2 px-4 rounded-full hover:bg-blue-200 flex items-center justify-center gap-2 text-center text-[1rem] font-[600]">Get Started <AiFillAndroid /></button>
